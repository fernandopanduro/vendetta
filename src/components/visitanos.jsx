    ...
    return (
        <section id='visitanos' className={`${styles.visitanos} contenedor`}>
            ...
            <div className={styles.descripcion}>
                <Fade bottom>
                    <p className="parrafo">Visitanos y entre la gran variedad de estilos, opta por la mejor opcion para ti.</p>
                    <p className="parrafo">Avenida de las torres 5624 Real Del Valle Mazatlán, Sinaloa, México.</p>
                    <a name='telefono de vendetta' className="parrafo" href='tel:6693251837'> <FaPhoneAlt /> 669 325 1837</a>
                </Fade>
